...
public abstract class PresentrModule : IdComponent, IAsyncDisposable
{
    ...
    protected DotNetObjectReference<PresentrModule>? Interop { get; set; }
    ...
    protected virtual void OnLoadJSModule()
    {
        ...
        if (attr != null)
        {
            ...
            {
                Interop = DotNetObjectReference.Create<PresentrModule>(this);
            }
