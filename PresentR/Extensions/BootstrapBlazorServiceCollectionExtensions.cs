...
using PresentR.Localization.Json;
using PresentR.Services;
...
public static class BootstrapBlazorServiceCollectionExtensions
{
    ...
    /// <returns></returns>
    public static IServiceCollection AddBootstrapBlazor(this IServiceCollection services, Action<PresentrOptions>? configureOptions = null, Action<JsonLocalizationOptions>? localizationConfigure = null)
    {
    ...
    /// <param name="configureOptions"></param>
    /// <returns></returns>
    private static IServiceCollection ConfigureBootstrapBlazorOption(this IServiceCollection services, Action<PresentrOptions>? configureOptions = null)
    {
        services.AddOptionsMonitor<PresentrOptions>();
        services.Configure<PresentrOptions>(op =>
        {
            // 设置默认文化信息
